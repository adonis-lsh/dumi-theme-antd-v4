...
const useMenu = (options: UseMenuOptions = {}): [MenuItemType[] | undefined, string] => {
  ...
  const sidebarEnhanceMenuItems = useMemo<MenuItemType[] | undefined>(() => {
    ...
    function processMenu(menu: SidebarEnhanceType): MenuItemType | null {
  ...
  const menuItems = useMemo<MenuItemType[]>(() => {
    ...
    return (
      sidebarItems?.reduce<MenuItemType[]>((result, group) => {
        if (group?.title) {
